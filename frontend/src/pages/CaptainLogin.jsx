  ...
  return (
    <div className='px-6 py-1'>
      ...
      <div className='flex flex-col justify-between h-[45vh]'>
        <h2 className='w-full text-center font-bold'>New here? <Link to='/captains/register' className='text-blue-800 underline'>Sign Up</Link></h2>
        <Link to='/users/login' className='w-full bg-amber-600 font-bold text-center text-xl text-zinc-900 rounded-lg py-2'>Login as User</Link>
      </div>
